...
$input_classes = 'w-full px-component-sm py-component-sm border rounded-medium text-text bg-surface-alt font-sans placeholder-text-muted transition-all duration-200 focus:outline-none focus:bg-surface focus:ring-2 focus:ring-primary focus:border-transparent ' . $input_class;
